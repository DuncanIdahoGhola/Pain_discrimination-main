...
urllib.request.urlretrieve(
    ...
    "derivatives/arialnarrow.ttf",
)
fm.fontManager.addfont("derivatives/arialnarrow.ttf")
...
wide_dat.to_csv(opj("derivatives", "wide_dat_full.csv"), index=False)
all_eval_frame.to_csv(opj("derivatives", "all_eval_frame_full.csv"), index=False)
all_discrim_task.to_csv(opj("derivatives", "all_discrim_task_full.csv"), index=False)
all_discrim_task_long.to_csv(opj("derivatives", "all_discrim_task_long_full.csv"), index=False)
